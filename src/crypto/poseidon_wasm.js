...
export function buildPoseidonWasm(module) {
        ...
        c.loop(
          ...
          c.block(
            c.loop(
              ...
              c.call('frm_mul', c.getLocal('pState'), c.getLocal('pM'), c.i32_const(pAux)),
              c.call('frm_add', c.i32_const(pAux), c.getLocal('pStateAux'), c.getLocal('pStateAux')),
  ...
  function buildApplySMatrix() {
    ...
    f.addCode(
      ...
      c.block(
        c.loop(
          c.br_if(1, c.i32_eq(c.getLocal('i'), c.getLocal('t'))),
          c.call('frm_mul', c.getLocal('pState'), c.getLocal('pS'), c.i32_const(pAux)),
          c.call('frm_add', c.i32_const(pS0), c.i32_const(pAux), c.i32_const(pS0)),
      ...
      c.block(
        c.loop(
          c.br_if(1, c.i32_eq(c.getLocal('i'), c.getLocal('t'))),
          c.call('frm_mul', c.i32_const(pState), c.getLocal('pS'), c.i32_const(pAux)),
          c.call('frm_add', c.getLocal('pState'), c.i32_const(pAux), c.getLocal('pState')),
          c.setLocal('pS', c.i32_add(c.getLocal('pS'), c.i32_const(32))),
          c.setLocal('pState', c.i32_add(c.getLocal('pState'), c.i32_const(32))),
          c.setLocal('i', c.i32_add(c.getLocal('i'), c.i32_const(1))),
          c.br(0)
  ...
  function buildPoseidon() {
    ...
    f.addCode(
      ...
      c.setLocal(
        'pAux',
        c.i32_add(c.i32_const(pConstants), c.i32_mul(c.i32_sub(c.getLocal('n'), c.i32_const(1)), c.i32_const(20)))
      ),
      c.setLocal('nRoundsP', c.i32_load(c.getLocal('pAux'))),
      c.setLocal('pC', c.i32_load(c.i32_add(c.getLocal('pAux'), c.i32_const(4)))),
      c.setLocal('pS', c.i32_load(c.i32_add(c.getLocal('pAux'), c.i32_const(8)))),
      c.setLocal('pM', c.i32_load(c.i32_add(c.getLocal('pAux'), c.i32_const(12)))),
      ...
      c.block(
        c.loop(
          c.call(
            'frm_copy',
            c.i32_add(c.getLocal('pIn'), c.i32_mul(c.i32_sub(c.getLocal('i'), c.i32_const(1)), c.i32_const(32))),
            c.i32_add(c.i32_const(pState), c.i32_mul(c.getLocal('i'), c.i32_const(32)))
          ),
      ...
      c.block(
        c.loop(
          ...
          c.call(
            'frm_copy',
            c.i32_add(c.i32_const(pState), c.i32_mul(c.getLocal('i'), c.i32_const(32))),
            c.i32_add(c.getLocal('pOut'), c.i32_mul(c.getLocal('i'), c.i32_const(32)))
          ),
          c.setLocal('i', c.i32_add(c.getLocal('i'), c.i32_const(1))),
          c.br(0)
        )
