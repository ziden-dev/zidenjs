...
describe('test query sig', async () => {
  ...
  it('create trees for kyc service and holder', async () => {
    await setupParams();
    claimsDb = new SMTLevelDb('src/witnesses/db_test/query_sig5/claims');
    revocationDb = new SMTLevelDb('src/witnesses/db_test/query_sig5/revocation');
    rootsDb = new SMTLevelDb('src/witnesses/db_test/query_sig5/roots');
    ...
    holderTrees = await Trees.generateID(
      [holderAuthClaim],
      new SMTLevelDb('src/witnesses/db_test/query_sig5_holder/claims'),
      new SMTLevelDb('src/witnesses/db_test/query_sig5_holder/revocation'),
      new SMTLevelDb('src/witnesses/db_test/query_sig5_holder/roots'),
      IDType.Default
    );
  }).timeout(10000);
