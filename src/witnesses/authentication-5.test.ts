...
describe('test authentication', async () => {
  ...
  it('set up trees', async () => {
    ...
    const claimsDb = new SMTLevelDb('src/witnesses/db_test/auth5/claims');
    const revocationDb = new SMTLevelDb('src/witnesses/db_test/auth5/revocation');
    const rootsDb = new SMTLevelDb('src/witnesses/db_test/auth5/roots');
